window.onload = function (ev) {
    ...
    form.insertBefore(titleEl[6], ul[23]);  //  文章内容相关
    form.insertBefore(titleEl[7], ul[28]);  //  评论区
    form.insertBefore(titleEl[8], ul[32]);  //  导航栏
    form.insertBefore(titleEl[9], ul[34]);  //  友情链接
    form.insertBefore(titleEl[10], ul[37]);  //  开发者
