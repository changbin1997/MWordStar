...
主题针对屏幕阅读器做了大量优化，并 在 [NVDA](http://www.nvda-project.org/) 、[VoiceOver](https://www.apple.com/cn/accessibility/iphone/vision/) 、[TalkBack](https://en.wikipedia.org/wiki/TalkBack) 这些屏幕阅读器上做过测试，无论是 PC 还是移动设备都能完美朗读。主题能准确传达需要朗读的内容和信息，对于视障人群来说，使用标准的屏幕阅读器基本可以无障碍操作。
...
![MWordStar 评论动态日历图](screenshot/calendar-chart.png)
