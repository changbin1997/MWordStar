                ...
                <article>
                    <div data-target="<?php $this->options->postLinkOpen(); ?>" class="post-content" data-color="<?php echo $color['link']; ?>">
                        ...
                        <?php if ($this->options->pageLinks): ?>
                            ...
                            <div class="row link-box" role="group" aria-label="內頁鏈接">
                                        ...
                                        <div class="link">
                                            <a href="<?php echo $linkList[$i]->url; ?>" class="clearfix" target="_blank">
                                                <?php if (!isset($linkList[$i]->logoUrl) or $linkList[$i]->logoUrl == ''): ?>
                                                    <i class="link-logo float-left icon-link icon-logo rounded-circle" aria-label="站點Logo"></i>
                                                <?php else: ?>
                                                    <img src="<?php echo $linkList[$i]->logoUrl; ?>" alt="站點Logo" class="link-logo float-left rounded-circle">
                                                <?php endif; ?>
                        ...
                        <div class="row link-box" role="group" aria-label="全站鏈接">
                            <?php for ($i = 0;$i < count($linkList);$i ++): ?>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 link-grid">
                                    <div class="link">
                                        <a href="<?php echo $linkList[$i]->url; ?>" class="clearfix" target="_blank">
                        ...
                        <div class="row link-box" role="group" aria-label="首頁鏈接">
